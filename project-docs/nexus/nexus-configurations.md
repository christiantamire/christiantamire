...
> Companion file to [nexus-documentation.md](./nexus-documentation.md). Contains the running configuration commands for every device type referenced in that document. Router0 and the DMZ server configs are not included; they weren't supplied as part of this configuration set.
